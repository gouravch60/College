export const ALL_ENQUIRY_REQUEST = "Fetch all enquiry request"
...
export const UPDATE_ENQUIRY_FAIL    = "Update enquiry fail"
export const UPDATE_ENQUIRY_RESET    = "Update enquiry reset"

export const ENQUIRY_COUNT_REQUEST  = "Fetch enquiry count request"
export const ENQUIRY_COUNT_SUCCESS  = "Fetch enquiry count success"
export const ENQUIRY_COUNT_FAIL     = "Fetch enquiry count fail"